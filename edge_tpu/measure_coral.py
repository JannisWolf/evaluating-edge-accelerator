...
Example usage:
```
python3 measure_coral.py \
  --model model_quant_edgetpu.tflite
```
"""
...
def main():
  ...
  if input_details[0]['dtype'] == np.int8:
    ...
    test = testData / input_scale + input_zero_point
  ...
  for i in range(100):
    ...
    interpreter.set_tensor(input_details[0]['index'], t.astype(np.int8))
    #perform inference
    ...
    if input_details[0]['dtype'] == np.int8:
      ...
      output_data[i] = (output_data[i] - output_zero_point) * output_scale
